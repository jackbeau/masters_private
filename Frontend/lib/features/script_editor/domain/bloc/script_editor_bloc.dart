...
class ScriptEditorLoaded extends ScriptEditorState {
  ScriptEditorLoaded(PdfViewerController controller, InspectorPanel selectedInspector, EditorPanel selectedEditor, Mode mode, Tool selectedTool, {super.isCameraVisible, super.selectedAnnotation})
      : super(pdfController: controller, selectedInspector: selectedInspector, selectedEditor: selectedEditor, mode: mode, selectedTool: selectedTool);
