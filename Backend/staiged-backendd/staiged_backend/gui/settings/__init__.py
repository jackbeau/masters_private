...
from gui.settings.microphone_page import MicrophonePage
from gui.settings.camera_page import CameraPage
from gui.settings.stage_zones_page import StageZonesPage
    ...
    def __init__(self, controller, parent, *args, **kwargs):
        ...
        self.menu_items = [
            MenuDataItem(title="General",
                         image_path="gui/resources/settings_icon.png",
                         child="general"
                         ),
            MenuDataItem(title="Microphone",
                         image_path="gui/resources/microphone_icon.png",
                         child=MicrophonePage
                         ),
            MenuDataItem(title="Camera",
                         image_path="gui/resources/camera_icon.png",
                         child=CameraPage
                         ),
            MenuDataItem(title="Stage Zones",
                         image_path="gui/resources/stage_zones_icon.png",
